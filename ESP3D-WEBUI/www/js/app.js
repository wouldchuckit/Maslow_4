...
// WiFi SSID validation pattern - allows any printable ASCII character
var SSID_PATTERN = "[\\x20-\\x7E]*";
var SSID_PATTERN_TITLE = "Allowed characters: all printable characters";
...
var getSSIDCharPatternRegex = function() {
  if (!SSID_CHAR_PATTERN_REGEX) {
    SSID_CHAR_PATTERN_REGEX = /^[\x20-\x7E]$/;
  }
